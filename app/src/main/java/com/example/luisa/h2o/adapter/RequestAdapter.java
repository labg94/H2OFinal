...
public class RequestAdapter extends ArrayAdapter<Solicitud> {

    public RequestAdapter(@NonNull Context context, List<Solicitud> solicitudList) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getContext(),RequestShower.class);
...
//            urgency.setTextColor(Color.RED);
//        }
        urgency.setText("Urgencia nivel "+ getItem(position).getUrgency());
